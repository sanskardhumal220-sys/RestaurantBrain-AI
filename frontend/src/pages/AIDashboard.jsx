...
const AIDashboard = () => {
 ...
 <p className="text-slate-500 dark:text-white mt-1">{t('ai_dash.subtitle')}</p>
 </div>
 </div>
 ...
 <span className="text-sm font-medium text-slate-500 dark:text-white">{t('ai_dash.revenue')}</span>
 </div>
 ...
 <span className="text-sm font-medium text-slate-500 dark:text-white">{t('ai_dash.orders')}</span>
 </div>
 ...
 <span className="text-sm font-medium text-slate-500 dark:text-white">{t('ai_dash.pending')}</span>
 </div>
 ...
 <span className="text-sm font-medium text-slate-500 dark:text-white">{t('ai_dash.stock_alerts')}</span>
 </div>
 ...
 <p className="text-sm text-slate-600 dark:text-white mt-2">{health.explanation}</p>
 </>
 ) : (
 <p className="text-slate-500 dark:text-white">{t('ai_dash.unavailable')}</p>
 )}
 </div>
 </div>
 ...
 <p className="text-sm text-slate-500 dark:text-white leading-relaxed">{rec.description}</p>
 </div>
 </motion.div>
 ))
 )}
