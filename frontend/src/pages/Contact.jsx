...
const Contact = () => {
 ...
 className="mt-4 text-xl text-slate-500 dark:text-white max-w-2xl mx-auto"
 >
 ...
 <p className="text-slate-500 dark:text-white mb-2">Our friendly team is here to help.</p>
 ...
 <p className="text-slate-500 dark:text-white mb-2">Mon-Fri from 8am to 5pm.</p>
 ...
 <p className="text-slate-500 dark:text-white mb-2">Come say hello at our HQ.</p>
 ...
 <div>
 <label className="block text-sm font-bold text-slate-700 dark:text-white mb-2">Your Name</label>
 <input 
 type="text" 
 required
 ...
 <div>
 <label className="block text-sm font-bold text-slate-700 dark:text-white mb-2">Email Address</label>
 <input 
 type="email" 
 required
 className="w-full px-5 py-4 border border-slate-200 dark:border-slate-700 rounded-2xl focus:ring-2 focus:ring-primary/20 focus:border-primary bg-white dark:bg-transparent transition-colors outline-none transition-all shadow-sm"
 ...
 <div>
 <label className="block text-sm font-bold text-slate-700 dark:text-white mb-2">Subject</label>
 <input 
 type="text" 
 required
 className="w-full px-5 py-4 border border-slate-200 dark:border-slate-700 rounded-2xl focus:ring-2 focus:ring-primary/20 focus:border-primary bg-white dark:bg-transparent transition-colors outline-none transition-all shadow-sm"
 ...
 <div>
 <label className="block text-sm font-bold text-slate-700 dark:text-white mb-2">Message</label>
 <textarea 
 required
 rows="5"
